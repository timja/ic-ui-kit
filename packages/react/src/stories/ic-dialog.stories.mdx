...
import { IcButton, IcCheckbox, IcCheckboxGroup, IcDialog, IcTextField, IcSelect } from "../components";
...
<Canvas>
  <Story name="Slotted content">
        ...
        >
          ...
          <IcTextField label="What is your favourite coffee?"></IcTextField>
          <IcSelect label="What is your favourite coffee?" options={options}></IcSelect>
...
<Canvas>
  <Story name="Scrollable" parameters={{ loki: { skip: true } }}>
      <IcButton variant="primary" onclick={showScrollableDialog}>Launch scrollable dialog</IcButton>
      <IcDialog
