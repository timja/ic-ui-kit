...
<Canvas>
  <Story name="Interaction controls">
    ...
    >
      ...
      <IcButton slot="interaction-controls" variant="primary">Learn more</IcButton>
      <IcButton slot="interaction-controls" variant="secondary">Hide</IcButton>
    </IcCard>
  </Story>
</Canvas>
