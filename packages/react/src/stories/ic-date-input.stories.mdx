...
### Default date (past disabled)

<Canvas>
  <Story name="Default date (past disabled)">
    <IcDateInput
      label="When would you like to collect your coffee?"
      value="25-05-2005"
      disablePast
...
<Canvas>
  <Story name="Dates in past disabled">
    <>
      <IcDateInput
        label="When would you like to collect your coffee?"
        disablePast
...
<Canvas>
  <Story name="Dates in future disabled">
    <>
      <IcDateInput
        label="When would you like to collect your coffee?"
        disableFuture
...
<Canvas>
  <Story name="Min and max">
    <>
      ...
      />
      <IcTypography>
        Enter a date after 2nd Jan 2023 and before 20th July 2023.
      </IcTypography>
    </>
  </Story>
</Canvas>
