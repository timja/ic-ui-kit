...
import {
  ...
  TopNavWithNavItems,
  TopNavWithSearch,
} from "./testData/IcTopNavigationTestData";
...
describe("IcTopNavigation", () => {
  describe("mobile", () => {
    ...
    it("renders", () => {
      mount(<SimpleTopNav />);
      cy.get("ic-top-navigation").shadow().contains("AppName");
    });

    it("should open and close menu", () => {
      mount(<SimpleTopNav />);
      cy.clickOnShadowEl("ic-top-navigation","ic-button")
      cy.findShadowEl("ic-top-navigation", "ic-navigation-menu").shadow().find("ic-button") .click()
    });
    ...
    it("should toggle search bar when clicking on button", () => {
     ...
     cy.findShadowEl("ic-top-navigation","ic-button").first().click();
      cy.get("ic-search-bar").should(
        "have.css",
        "height",
        "40px"
      );
      cy.findShadowEl("ic-top-navigation","ic-button").first().click();
      cy.get("ic-search-bar").should("have.css", "height", "0px");
    });
    ...
    it("should hide search bar when loses focus", () => {
      ...
      cy.get("ic-search-bar").should("be.visible").should("have.focus").blur();
      cy.get("ic-search-bar").should("have.css", "height", "0px");
    });
  ...
  it("should toggle to short title at small screen sizes", () => {
    mount(<SimpleTopNav />);
    cy.viewport(1024, 750);
    cy.findShadowEl("ic-top-navigation", "h1").contains("ApplicationName");
    cy.viewport("iphone-6");
    cy.findShadowEl("ic-top-navigation", "h1").contains("AppName");
...
describe("IcTopNavigation Mobile Visual Regression Testing", () => {
  ...
  it("renders with menu open", () => {
    ...
    cy.clickOnShadowEl("ic-top-navigation","ic-button#menu-button");
