...
export namespace Components {
    ...
    interface IcPopoverMenu {
        ...
        /**
          * If `true`, the ic-popover-menu will open when a MouseEvent button press occurs. If the "anchor" property element id is defined, this will only happen when clicking within the bounds of the anchor element. mouseButtonsOpenPopover can be used to define which mouse buttons can trigger this behaviour: by default this is a left click.
         */
