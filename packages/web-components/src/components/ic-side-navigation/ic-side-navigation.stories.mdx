...
<Canvas>
  <Story name="Using unnamed slots" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="display:flex; height: 100%;">
        <ic-side-navigation
          app-title="Application Name"
...
<Canvas>
  <Story name="Slots using app-title" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="display:flex; height: 100%;">
        <ic-side-navigation
          version="v0.0.0"
...
<Canvas>
  <Story name="Slots using app-title expanded" parameters={{ layout: "fullscreen" }}>
    {html`
      <div style="display:flex; height: 100%;">
        <ic-side-navigation
          version="v0.0.0"
