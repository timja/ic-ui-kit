...
export class PaginationBar {
   ...
   */
  @Prop() paginationItemDisplay?: IcPaginationItemDisplayTypes = "page";
  /**
   * Whether the displayed pagination is simple or complex.
   */
  @Prop() paginationType?: IcPaginationTypes = "simple";
  ...
  private resizeObserverCallback = (currSize: number) => {
    if (Math.abs(currSize - this.paginationWidth) > 50) {
      ...
      >
        {(showItemsPerPage || showItemsPerPageControl) && (
          <div class="item-controls">
            ...
            {showItemsPerPage && paginationItemDisplay === "data" ? (
              <ic-typography
                class={{
                  [`pagination-text-${appearance}`]: true,
