    ...
    {(args) =>
      html`<ic-select
        ...
        <script>
          ...
          select.options = [
            {
              label: "Cappuccino etert ert erterter tert reterterter",
              value: "Cap",
            },
  ...
  <Story name="Validation">
    {(args) =>
      html`<ic-select
        ...
        ></ic-select>
        <script>
          var select1 = document.querySelector("#ic-select-16");
        ...
        ></ic-select>
        <script>
          var select2 = document.querySelector("#ic-select-17");
        ...
        ></ic-select>
        <script>
          var select3 = document.querySelector("#ic-select-18");
  ...
  >
    {(args) =>
      html`<ic-section-container>
        ...
        <script>
          const searchSelect = document.getElementById("select-22");
          let options = [];
