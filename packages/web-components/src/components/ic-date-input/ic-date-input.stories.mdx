    ...
    {html`<ic-date-input
      ...
      <script>
        ...
        btn.addEventListener("click", () => {
          ...
          dateInputWithValue.value = "31/12/2005";
          // console.log(dateInputWithValue);
        });
...
<Canvas>
  <Story name="Default date / Disabled date (until-now)">
    {html`<ic-date-input
        id="date-input-default-date-string"
        label="When would you like to collect your coffee?"
...
<Canvas>
  <Story name="with alert and validation" parameters={{ loki: { skip: true } }}>
    {html`
      ...
      <script>
        const alert = document.querySelector("ic-alert");
