...
### Default date / Disabled past dates

<Canvas>
  <Story name="Default date / Disabled past dates">
    {html`<ic-date-input
        id="date-input-default-date-string"
        label="When would you like to collect your coffee?"
        disable-past
...
### Default date / Disabled future dates

<Canvas>
  <Story name="Default date / Disabled future dates">
    {html`<ic-date-input
        id="date-input-default-date-string"
        label="When would you like to collect your coffee?"
        disable-future
...
### a11y: disabled past dates

<Canvas>
  <Story name="a11y: disabled past dates" parameters={{ loki: { skip: true } }}>
    {(args) =>
      html` <ic-date-input
          label="When would you like to collect your coffee?"
...
### a11y: default dates - disabled past dates

<Canvas>
  <Story
    name="a11y: default dates - disabled past dates"
