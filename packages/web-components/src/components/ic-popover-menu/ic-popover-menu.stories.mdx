  ...
  <Story name="Mouse anchor">
    {() => {
        ...
        return (
            <>
                <IcButton id="button-1" onClick={buttonClick}>Show popover</IcButton>
                <div id="contextual-area" style={{margin: '40px', width: '650px', height: '450px', backgroundColor: 'lightgreen', border: '2px solid green'}}>    
                    <div style={{textAlign: 'center', margin: '20px'}}>Right click in here for contextual menu</div>    
                </div>
                <IcPopoverMenu anchor="button-1" click-event-ele="contextual-area" open-on-mouse-event-button-press aria-label="popover">
                    <IcMenuItem label="Copy code" disabled />
                    <IcMenuGroup label="View">
                        <IcMenuItem label="Zoom in" keyboardShortcut="Cmd+" />
                        <IcMenuItem label="Zoom out" keyboardShortcut="Cmd-" />
